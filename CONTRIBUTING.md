...
### :fork_and_knife: Step 1: Fork _defsec_
...
### :arrow_down: Step 6: Apply the New Rule in _tfsec_

> NOTE: If you'd like to earn bonus points and support running your rule against _CloudFormation_, you can repeat this step in the [cfsec](https://github.com/aquasecurity/cfsec) repository - if not we'll get to it eventually and make sure your rule runs everywhere!
...
### :checkered_flag: Step 7: Prepare a _tfsec_ Pull Request
