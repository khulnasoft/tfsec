...
[![GoReportCard](https://goreportcard.com/badge/github.com/khulnasoft/tfsec)](https://goreportcard.com/report/github.com/khulnasoft/tfsec)
...
```console
curl -s https://raw.githubusercontent.com/khulnasoft/tfsec/master/scripts/install_linux.sh | bash
```
...
The binaries on the [releases page](https://github.com/khulnasoft/tfsec/releases) are signed with the tfsec signing key `D66B222A3EA4C25D5D1A097FC34ACEFB46EC39CE`
...
| ----------------------------------------------------------------------------- | ------- | -------------------------------------------------------------------------------------- |
| [khulnasoft/tfsec](https://hub.docker.com/r/khulnasoft/tfsec)                 | alpine  | Normal tfsec image                                                                     |
| [khulnasoft/tfsec-alpine](https://hub.docker.com/r/khulnasoft/tfsec-alpine)   | alpine  | Exactly the same as khulnasoft/tfsec, but for those whole like to be explicit          |
| [khulnasoft/tfsec-ci](https://hub.docker.com/r/khulnasoft/tfsec-ci)           | alpine  | tfsec with no entrypoint - useful for CI builds where you want to override the command |
| [khulnasoft/tfsec-scratch](https://hub.docker.com/r/khulnasoft/tfsec-scratch) | scratch | An image built on scratch - nothing frilly, just runs tfsec                            |
...
If you want to run tfsec on your repository as a GitHub Action, you can use [https://github.com/khulnasoft/tfsec-pr-commenter-action](https://github.com/khulnasoft/tfsec-pr-commenter-action).

## Use as an Azure DevOps Pipelines Task

You can now install the [official tfsec task](https://marketplace.visualstudio.com/items?itemName=AquaSecurityOfficial.tfsec-official). Please raise any issues/feature requests on the [task repository](https://github.com/khulnasoft/tfsec-azure-pipelines-task).
...
<a href = "https://github.com/khulnasoft/tfsec/graphs/contributors">
  <img src = "https://contrib.rocks/image?repo=khulnasoft/tfsec"/>
</a>
...
Join the community, and talk to us about any matter in [GitHub Discussion](https://github.com/khulnasoft/tfsec/discussions) or [Slack](https://slack.aquasec.com).
